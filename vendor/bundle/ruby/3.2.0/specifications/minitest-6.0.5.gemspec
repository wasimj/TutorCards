...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<prism>.freeze, ["~> 1.5"])
  s.add_runtime_dependency(%q<drb>.freeze, ["~> 2.0"])
  s.add_development_dependency(%q<rdoc>.freeze, [">= 6.0", "< 8"])
  s.add_development_dependency(%q<simplecov>.freeze, ["~> 0.21"])
  s.add_development_dependency(%q<hoe>.freeze, ["~> 4.6"])
end
